...
sessions_base AS (
  ...
  LEFT JOIN session_message_flags sha
...
OPTIMIZE ${FQN}
ZORDER BY (mes, economic_group_canonical, organization_name);

ANALYZE TABLE ${FQN}
COMPUTE STATISTICS FOR COLUMNS
  mes, dia, economic_group_canonical, economic_group_name,
  organization_name, organization_id,
  tipo_atendimento_agent, tipo_finished_by, tipificacao, finished_by, teve_user;
`;
