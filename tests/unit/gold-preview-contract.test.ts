...
const minimo = {
  ...
  internacao: { por_agrupamento: [], linhas_assistenciais: 0, internacoes_distintas: 0, beneficiarios_unicos: 0, dias_internados: 0, custo_medio: 0, duracao_mediana_dias: 0, duracao_p90_dias: 0 },
