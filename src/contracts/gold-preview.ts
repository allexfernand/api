...
export const goldPreviewSchema = z.object({
  ...
  internacao: z.object({
    ...
    por_saude_mental: z.array(z.object({
      saude_mental: z.boolean(),
      episodios: z.number(),
      beneficiarios: z.number(),
      custo: z.number(),
      custo_medio: z.number(),
      duracao_mediana_dias: z.number(),
      duracao_p90_dias: z.number(),
      cobertura_duracao: z.number(),
      reembolso_custo: z.number(),
    })),
  }),
  saude_mental: z.object({
    ...
    servicos: z.number(),
    reembolso_custo: z.number(),
    reembolso_share: z.number().nullable(),
    por_tema: z.array(z.object({ tema: z.string(), custo: z.number(), beneficiarios: z.number(), servicos: z.number(), share: z.number().nullable() })),
  }),
