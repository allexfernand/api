...
export function ExecutiveKpis({ kpis }: { kpis: TimelineKpis | null }) {
  ...
  return (
    <div className={styles.kpiGrid}>
      ...
      <Kpi lineageId="kpi.hospitalization_episodes" label="Episódios de internação" value={number.format(kpis.hospitalization_episodes)} helper="períodos contínuos por pessoa" />
