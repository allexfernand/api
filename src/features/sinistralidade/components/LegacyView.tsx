...
// Experiência 1.0.0 preservada (fotografia mensal). Continua sendo o
// fallback quando SINISTRALIDADE_360_LONGITUDINAL_ENABLED está desligada.
    ...
    <>
      <header className={styles.hero}>
        ...
        <div className={styles.controls}>
          <label>Empresa
            <select className="filter-select" value={companyKey} onChange={(event) => onCompanyChange(event.target.value)}>
