...
export default function Page() {
  ...
  return (
    <>
      ...
      <Script src="/scripts/dashboard.js?v=20260723-partner-vp02-jan26" strategy="afterInteractive" />
      <Script src="/scripts/gold-preview.js?v=20260723-partner-vp02-jan26" strategy="afterInteractive" />
    </>
  );
}
