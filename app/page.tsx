...
export default function Page() {
  ...
  return (
    <>
      ...
      <Script src="/scripts/dashboard.js?v=20260723-partner-vp03-session-months" strategy="afterInteractive" />
      <Script src="/scripts/gold-preview.js?v=20260723-partner-vp03-session-months" strategy="afterInteractive" />
    </>
  );
}
