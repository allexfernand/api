...
export default function Page() {
  ...
  return (
    <>
      ...
      <Script src="/scripts/dashboard.js?v=20260722-partner-multi" strategy="afterInteractive" />
      <Script src="/scripts/gold-preview.js?v=20260722-partner-multi" strategy="afterInteractive" />
    </>
  );
}
